...
ax.plot([31079470, 9261253, 71777922, 46805191], ["A Clockwork Orange", "Dr. Strangelove", "2001: A Space Odyssey", "The Shining"])  # Plot some data on the Axes.
ax.set_xlabel('Movies')    #Titles
ax.set_ylabel('Worldwide Box Office Dollars')
